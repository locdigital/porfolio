...
const Component = React.forwardRef<HTMLDivElement, ComponentProps>(
  ({ className, images = defaultImages, ...props }, ref) => {
    // Ensure we have enough images
    const displayImages = images.length >= 10 ? images : [...images, ...defaultImages].slice(0, 10);
    ...
    return (
      <div ref={ref} className={className} {...props}>
        ...
        <section className='imask-grid'>
          <figure className='imask-figure' style={{ clipPath: 'url(#clip-pattern)' }}>
            <img
              src={displayImages[0]}
              alt=''
              className='imask-img'
          ...
          <figure className='imask-figure' style={{ clipPath: 'url(#clip-pattern1)' }}>
            <img
              src={displayImages[1]}
              alt=''
              className='imask-img'
          ...
          <figure className='imask-figure' style={{ clipPath: 'url(#clip-pattern2)' }}>
            <img
              src={displayImages[2]}
              alt=''
              className='imask-img'
          ...
          <figure className='imask-figure' style={{ clipPath: 'url(#clip-pattern3)' }}>
            <img
              src={displayImages[3]}
              alt=''
              className='imask-img'
          ...
          <figure className='imask-figure' style={{ clipPath: 'url(#clip-pattern4)' }}>
            <img
              src={displayImages[4]}
              alt=''
              className='imask-img'
          ...
          <figure className='imask-figure' style={{ clipPath: 'url(#clip-pattern5)' }}>
            <img
              src={displayImages[5]}
              alt=''
              className='imask-img'
          ...
          <figure className='imask-figure' style={{ clipPath: 'url(#clip-pattern6)' }}>
            <img
              src={displayImages[6]}
              alt=''
              className='imask-img'
          ...
          <figure className='imask-figure' style={{ clipPath: 'url(#clip-pattern7)' }}>
            <img
              src={displayImages[7]}
              alt=''
              className='imask-img'
          ...
          <figure className='imask-figure' style={{ clipPath: 'url(#clip-pattern8)' }}>
            <img
              src={displayImages[8]}
              alt=''
              className='imask-img'
        ...
        <section className='imask-banner mt-4'>
